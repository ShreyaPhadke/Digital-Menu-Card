...
def CostofItem():
    ...
    Tax="Rs."+str('%.2f'%((PriceofDrinks + PriceofCakes + 1)*0.05))
    PaidTax.set(Tax)
...
def Receipt():
    ...
    txtReceipt.insert(END,"\n"+'Cost of Drinks:\t\t' + CostofDrinks.get() + '\tGST:\t' + PaidTax.get()+"\n")
    txtReceipt.insert(END, 'Cost of Cakes:\t\t' + CostofCakes.get() +  '\tTotal Cost:\t' + TotalCost.get() +"\n")
